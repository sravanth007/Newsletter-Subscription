...
class Actions extends \Magento\Newsletter\Controller\Subscriber\NewAction
{
    /**
        ...
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            try {
                ...
                if ($subscriber->getId()
                    ...
                    $result['message'] = __('This  email id is already under subscription.');
                } else {
                    ...
                    if ($status == \Magento\Newsletter\Model\Subscriber::STATUS_NOT_ACTIVE) {
                        ...
                        $result['message'] = __('Thank you  for the subscription.');
                        $result['error'] = false;
                    }
                }
